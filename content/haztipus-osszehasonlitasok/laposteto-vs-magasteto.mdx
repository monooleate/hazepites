...
A magastető egyedülálló előnye: a tetőtér beépíthető. A beépíthető szaruzat és a nem beépíthető rácsostartó közti döntésről külön cikk szól: [beépített vagy nem beépített tetőtér](/tervezes/tetoter-beepites).
