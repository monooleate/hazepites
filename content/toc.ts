  ...
  content: {
    ...
    haztipusok: {
      ...
      pages: [
        ...
        ["page", "cnc-favazas-keszhaz", "CNC favázas készház"],
        ["page", "belso-falak-konnyuszerkezet", "Belső falak könnyűszerkezetnél"],
        ["page", "fahaz", "Faház"],
    ...
    "haztipus-osszehasonlitasok": {
      ...
      pages: [
        ...
        ["page", "kulcsrakesz-vs-generalkivitelezes", "Kulcsrakész vs generálkivitelezés"],
      ],
    },
    koltsegek: {
      title: "Költségek",
      pages: [
        ...
        ["page", "keszultsegi-fokok", "Készültségi fokok"],
        ["page", "afa-hazepites", "Áfa a házépítésnél"],
        ...
        ["page", "belso-burkolatok", "Belső burkolatok költsége"],
    ...
    energia: {
      ...
      pages: [
        ...
        ["page", "farost-szigeteles", "Farost hőszigetelés"],
        ["page", "diffuzio-nyitott-falszerkezet", "Diffúziónyitott falszerkezet"],
    ...
    tervezes: {
      ...
      pages: [
        ...
        ["page", "tetoter-beepites", "Tetőtér beépítés"],
    ...
    jog: {
      ...
      pages: [
        ...
        ["page", "keszhaz-szerzodes-buktatok", "Készház szerződés buktatói"],
    ...
    kivitelezes: {
      ...
      pages: [
        ...
        ["page", "villamos-halozat", "Villamos hálózat"],
        ["page", "viz-szennyviz-rendszer", "Víz- és szennyvízrendszer"],
    ...
    telek: {
      ...
      pages: [
        ...
        ["page", "talajcsavaros-alapozas", "Talajcsavaros alapozás"],
